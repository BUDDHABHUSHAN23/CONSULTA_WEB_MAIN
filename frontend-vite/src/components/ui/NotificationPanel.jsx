...
export default function NotificationPanel() {
  ...
  return (
    <div className="fixed right-4 top-[calc(var(--ann-bar-h,0px)+72px)] z-[1001]">
      <div className="w-[360px] max-w-[92vw] bg-white/90 backdrop-blur-xl border border-gray-200 rounded-2xl shadow-2xl overflow-hidden">
